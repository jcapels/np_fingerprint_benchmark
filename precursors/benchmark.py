...
def _optimize(datasets, steps, pipeline_name):
    ...
    for tuple_datasets in datasets:
        ...
        for train_dataset, validation_dataset, test_dataset in tuple_datasets:
            ...
            po = PipelineOptimization(direction='maximize', study_name=f'plant_precursor_prediction_prediction_{pipeline_name}_fold_{fold_idx}_rep{rep}', sampler=optuna.samplers.TPESampler(seed=43),
                                    storage=f'sqlite:///plant_precursor_prediction_prediction.db')
