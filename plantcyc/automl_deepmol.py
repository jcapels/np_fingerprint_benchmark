...
po = PipelineOptimization(direction='maximize', study_name='plantcyc_pathway_prediction_deepchem', sampler=optuna.samplers.TPESampler(seed=43),
                          storage='sqlite:///plantcyc_pathway_prediction_deepchem.db')
...
po.optimize(datasets=datasets, objective_steps='deepchem',
            metric=metric, n_trials=50, data=data, save_top_n=5, trial_timeout=60*60*24,
