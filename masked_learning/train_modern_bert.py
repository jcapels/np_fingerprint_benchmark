...
def train_model(train_dataset, validation_dataset):
    ...
    model.save("data/train_test_split_scaffolds/ModernBERT_small")
...
def evaluate_model(test_dataset):
    from deepmol.models import ModernBERT
    model = ModernBERT.load("data/train_test_split_scaffolds/ModernBERT_small", mode="masked_learning")
    # model.evaluate(train_dataset))
    # print(model.evaluate(validation_dataset))
