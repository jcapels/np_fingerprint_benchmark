...
class NPBERTDataset(TorchDataset, SmilesDataset):
    ...
    def __init__(self,
        ...
        if vocabulary_path is None:
            dir_path = os.getcwd()
            NPBERTTokenizer.export_vocab(self, os.path.join(dir_path, "vocab.txt"))
            self.tokenizer = NPBERTTokenizer(os.path.join(dir_path, "vocab.txt"))
        else:
            self.tokenizer = NPBERTTokenizer(vocabulary_path)
...
class CSVLoaderNPBERT(CSVLoader):
    ...
    def create_dataset(self, **kwargs) -> SmilesDataset:
        ...
        return NPBERTDataset(smiles=mols,
                             X=X,
                             y=y,
                             ids=ids,
